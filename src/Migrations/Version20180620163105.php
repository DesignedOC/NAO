 ...
 */
final class Version20180620163105 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nao_taxref DROP taxref_file');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nao_taxref ADD taxref_file VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
